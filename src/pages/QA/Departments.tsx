...
import { Plus, Trash2, Building2, X, Save } from 'lucide-react'
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => { setShowModal(true); setError(''); setForm({ name: '', code: '' }) }}
      ...
      {loading ? (
        ...
        <div style={{
          ...
          >
            {['Department Name', 'Code', 'Date Added', ''].map(h => (
              <p key={h} style={{
                fontSize: '11px',
                fontWeight: 500,
                color: '#94a3b8',
          ...
          {departments.map((dept, i) => (
            <div
              ...
              style={{
                gridTemplateColumns: '1fr 120px 160px 60px',
                padding: '12px 16px',
                borderBottom: i < departments.length - 1 ? '0.5px solid #f1f5f9' : 'none',
